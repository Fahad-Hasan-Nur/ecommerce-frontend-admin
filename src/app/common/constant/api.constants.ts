...
const USER_TRANSACTION_SERVICE = SERVICE_API + 'api/user/transaction/';
export const USER_API = {
     ADD_USER_CART_PRODUCT: USER_TRANSACTION_SERVICE +'userProduct/add/',
     GET_CART_PRODUCT:USER_TRANSACTION_SERVICE+'getOnCart/',
     DELETE_CART_PRODUCT:USER_TRANSACTION_SERVICE+'userProduct/delete/',
     ORDER_USER_PRODUCT: USER_TRANSACTION_SERVICE+'orderProduct/',
     GET_PRODUCT_BY_ORDER: USER_TRANSACTION_SERVICE+'getByOrder/',
};
...
const USER_ORDER_SERVICE = SERVICE_API + 'api/user/order/';
export const USER_ORDER_API = {
     GET_USER_ORDER_BY_USER_ID: USER_ORDER_SERVICE +'getByUserId/',
     GET_USER_ORDER_BY_STATUS: USER_ORDER_SERVICE +'getByStatus/',
     UPDATE_ORDER: USER_ORDER_SERVICE ,
     DELETE_ORDER: USER_ORDER_SERVICE ,
};

const DELIBVARY_CONTACT_INFO_SERVICE = SERVICE_API + 'api/delivary/contactInfo/';
export const DELIBVARY_CONTACT_INFO_API = {
     GET_DELIVARY_CONTACT_INFO_BY_ID: DELIBVARY_CONTACT_INFO_SERVICE,
};

const DELIBVARY_LOCATION_INFO_SERVICE = SERVICE_API + 'api/delivary/locationInfo/';
export const DELIBVARY_LOCATION_INFO_API = {
     GET_DELIBVARY_LOCATION_INFO_BY_ID: DELIBVARY_LOCATION_INFO_SERVICE,
};
